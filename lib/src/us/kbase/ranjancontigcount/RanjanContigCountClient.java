package us.kbase.ranjancontigcount;
...
/**
 * <p>Original spec-file module name: ranjanContigCount</p>
 * <pre>
 * A KBase module: ranjanContigCount
 * </pre>
 */
public class RanjanContigCountClient {
     ...
     */
    public RanjanContigCountClient(URL url) {
     ...
     * validity.
     */
    public RanjanContigCountClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public RanjanContigCountClient(URL url, String user, String password) throws UnauthorizedException, IOException {
